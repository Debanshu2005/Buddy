...
Servo specs:
  ...
  - Connected to GPIO 18 (physical pin 12) — hardware PWM
...
class ServoController:
    ...
    # NOTE: These are SWAPPED because the servo range is inverted on this hardware
    POS_DOWN   = 150  # Looking down (face detected)
    POS_CENTER = 90   # Eye level (neutral)
    POS_UP     = 30   # Looking up (searching for face, no face detected)
